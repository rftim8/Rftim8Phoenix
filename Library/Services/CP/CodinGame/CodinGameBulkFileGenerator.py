...
cwd = f"{os.getcwd()}/RftData/CP/CodinGame/Templates/"
filename = f"{cwd}CodinGameProblemNames.txt"

cwd_target_dir = f"{os.getcwd()}/RftCP/CodinGame/"
cwd_target_dir_io = f"{os.getcwd()}/RftData/CP/CodinGame/IO/"
...
def create_puzzles():
    ...
    template = open(f"{cwd}RftCodinGameCodeFileTemplate.txt", "r").read()
