...
with open(f"{cwd}/RftData/CP/AdventOfCode/IO/_15_Chiton_Input.txt") as input:
...
# region Unit Testing
class _15_Chiton_Test(unittest.TestCase):
    with open(
        f"{cwd}/RftData/CP/AdventOfCode/IO/_15_Chiton_Output.txt"
    ) as input:
        l = input.read().strip().splitlines()
