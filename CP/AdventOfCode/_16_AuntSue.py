...
with open(f"{cwd}/RftData/CP/AdventOfCode/IO/_16_AuntSue_Input.txt") as input:
...
# region Unit Testing
class _16_AuntSue_Test(unittest.TestCase):
    with open(
        f"{cwd}/RftData/CP/AdventOfCode/IO/_16_AuntSue_Output.txt"
    ) as input:
        l = input.read().strip().splitlines()
