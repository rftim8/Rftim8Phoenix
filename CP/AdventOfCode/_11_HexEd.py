...
with open(f"{cwd}/RftData/CP/AdventOfCode/IO/_11_HexEd_Input.txt") as input:
...
# region Unit Testing
class _11_HexEd_Test(unittest.TestCase):
    with open(
        f"{cwd}/RftData/CP/AdventOfCode/IO/_11_HexEd_Output.txt"
    ) as input:
        l = input.read().strip().splitlines()
