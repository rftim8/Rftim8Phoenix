...
with open(f"{cwd}/RftData/CP/AdventOfCode/IO/_02_Dive_Input.txt") as input:
...
# region Unit Testing
class _02_Dive_Test(unittest.TestCase):
    with open(
        f"{cwd}/RftData/CP/AdventOfCode/IO/_02_Dive_Output.txt"
    ) as input:
        l = input.read().strip().splitlines()
