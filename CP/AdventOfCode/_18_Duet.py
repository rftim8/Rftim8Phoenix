...
with open(f"{cwd}/RftData/CP/AdventOfCode/IO/_18_Duet_Input.txt") as input:
...
# region Unit Testing
class _18_Duet_Test(unittest.TestCase):
    with open(
        f"{cwd}/RftData/CP/AdventOfCode/IO/_18_Duet_Output.txt"
    ) as input:
        l = input.read().strip().splitlines()
