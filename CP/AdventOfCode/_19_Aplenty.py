...
with open(f"{cwd}/RftData/CP/AdventOfCode/IO/_19_Aplenty_Input.txt") as input:
...
# region Unit Testing
class _19_Aplenty_Test(unittest.TestCase):
    with open(
        f"{cwd}/RftData/CP/AdventOfCode/IO/_19_Aplenty_Output.txt"
    ) as input:
        l = input.read().strip().splitlines()
